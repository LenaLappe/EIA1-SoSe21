window.addEventListener("load", function(){
    ...
    var beats: HTMLAudioElement[] = [new Audio('sounds/A.mp3'), new Audio('sounds/C.mp3'), new Audio('sounds/F.mp3'), new Audio ('sounds/G.mp3'), new Audio('sounds/hihat.mp3'), new Audio ('sounds/kick.mp3'), new Audio ('sounds/laugh-1.mp3'), new Audio ('sounds/laugh-2.mp3'), new Audio ('sounds/snare.mp3')]; 
    ...
    document.querySelector('.button9').addEventListener('click', function() {playSound("sounds/snare.mp3") });
        ...
        function playSound(sample_mp3){
            ...
            var sound:HTMLAudioElement = new Audio(sample_mp3);
            sound.play();
        };


            let drumMachine : HTMLAudioElement[] = [beats[5], beats[8], beats[5], beats[5], beats[8] ];
            let PositionImArray : number = 0

            document.querySelector('#playButton').addEventListener('click', function() {setInterval(
